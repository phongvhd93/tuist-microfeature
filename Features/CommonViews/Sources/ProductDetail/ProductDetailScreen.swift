...
public struct ProductDetailScreen: View {
    ...
    public let relatedProductsVM = CollectionViewModel(id: "1", name: "Related", products: Product.products)
...
public struct ProductDetailScreen_Previews: PreviewProvider {
