...
public struct ProductInformationView: View {
    ...
    public let viewModel: ProductInformationViewModel
    ...
    public init(viewModel: ProductInformationViewModel) {
        self.viewModel = viewModel
    }
}

public struct ProductInformation_Previews: PreviewProvider {
